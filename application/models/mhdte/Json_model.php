...
class json_model extends CI_Model
{
    ...
    public function getEmisor()
    {
        ...
        $this->db->from("emisor e");
         $this->db->where("e.codestab", $this->session->userdata( "codestab" ));
	...
	public function getCamposRecetor(){
		$campos= "
			...
			replace(r.telReceptor,'-','') as telefono,
	...
	public function modificarEstadoDte($numeroControl, $codigoGeneracion, $estado){
		$this->db->where('numeroControl', $numeroControl);
		$this->db->where('codigoGeneracion', $codigoGeneracion);
		$this->db->update('identificacion', $estado);
