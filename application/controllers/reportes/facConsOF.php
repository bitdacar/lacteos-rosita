...
class facConsOF extends CI_Controller {
...
function detalleTabla( $respuesta, $impuestos ){
    ...
    public function facConsOF() {

       //  $this->session->set_userdata( "areafact", "" ) ;
         
  sleep(2);
        //$numeroControl='DTE-01-CMPV0202-000000000000402';
        //$codigoGeneracion='ABA9FCA3-B920-42AA-AEDD-FFAE9478E01E';
