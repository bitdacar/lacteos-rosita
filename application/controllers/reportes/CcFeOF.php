...
class CcfeOF extends CI_Controller {
...
function detalleTabla( $respuesta, $impuestos ){
                    ...
                    <div class="col-md-12"><table class="table table-bordered text-center table-responsive" style="100%">
                        ...
                        for ( $i = 0; $i<count( $respuesta ); $i++ ) {
                            $detalleTablaFilas.='<tr>
                                ...
                                <td >'.number_format($respuesta[$i]->precioUnitario, 2, '.', ',' ).'</td>
    ...
    // if( $respuesta[0]->ivaPercibido>0){
          ...
          $respuesta[0]->ivaPercibido =='' ? $ivaPercibido= '0.00' :$ivaPercibido=$respuesta[0]->ivaPercibido; 
...
public function CcfeOF(){
        
        
         sleep(2);

        //$numeroControl='DTE-03-CMPV0202-000000001000359';
        //$codigoGeneracion='4C716099-BA56-4148-BF38-049FBADE5663';
