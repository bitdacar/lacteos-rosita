...
class facEx13R extends CI_Controller {
                     ...
                     <div class="col-xs-1 col-sm-1 col-md-1"></div>
                        <div class="col-xs-4 col-sm-4 col-md-4 text-left">
                            <div class="receipt-right">
                               <p><small>Nombre : '.$receptor[0]->codigo.' - '.$receptor[0]->nomComercial.'</small></p>
    ...
    $detalleTablaenca='<div class="row">
                    <div class="col-md-12"><table class="table table-bordered text-center table-responsive" style="100%">
                        ...
                        for ( $i = 0; $i<count( $respuesta ); $i++ ) {
                            ...
                            $ivaRetenido+= 0;//$respuesta[$i]->ivaRetenido;
                            ...
                            $detalleTablasubtotales='<tr>
                                ...
                                <td class="text-right">
                                   ...
                                   <p>
                                        <strong>'. utf8_decode( "Total " ).'</strong>
                                    </p>
                                    <p>
                                ...
                                <td class="text-right">
                                    ...
                                    <p>
                                        '.utf8_decode( "$ ".$ivaResumen ).'
                                    </p>
                                    <p>
                                        '.utf8_decode( "$ ". $ivaResumen ).'
                                    </p>   
                                    <p>
                                        '.utf8_decode(  "$ ".$totalGravado ).'
                                    </p>
                                    <p>
                                        '.utf8_decode(  "$ ".$rentaTotal ).'
                                    </p>                                    
    ...
    public function facEx13R(){
           sleep(2);
       //$numeroControl='DTE-14-CMPV0202-000000000005675';
       //$codigoGeneracion='75C50211-7D19-455D-8BFC-A4B032E3DE69';
