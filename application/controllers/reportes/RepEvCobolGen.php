...
class RepEvCobolGen extends CI_Controller {
 ...
 sleep(2);
        ...
        $respuesta=$this->integracion_model->ConsultasGenerales($fechini,$fechfin,$area,$txt,$id,$codestab);
       ...
       // $pdf->AddPage();
        ...
        $pdf->Ln( 4 );
        $pdf->Cell( 35 );
        $pdf->Cell( 175, 2, utf8_decode( strtoupper( "REPORTE POR CATALOGOS De: ".date('d/m/Y', strtotime($fechini) )." Hasta: ".date('d/m/Y', strtotime($fechfin) ) ) ), 0, 0, 'C' );
