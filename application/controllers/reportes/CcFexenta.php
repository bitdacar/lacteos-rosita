...
class CcFexenta extends CI_Controller {
...
function detalleTabla( $respuesta, $impuestos ){
    ...
    public function CcFexenta(){
        
        
         sleep(2);

        //$numeroControl='DTE-01-CMPV0202-000000001000352';
        //$codigoGeneracion='1A1CEC7C-396C-40E9-8269-47920416165F';
