...
class serviciosgenerales extends CI_Controller {
    ...
    public function NuevoComRete(){
        ...
        $cantidad = $this->input->post( "item80" );
        $precio = $this->input->post( "item85" );
        $procucto = $this->input->post( "item81" );
        $filas = $this->input->post( "item72" );
        $tipodocSelect = $this->input->post( "tipodocSelect" );
        $calculos = $this->input->post( "calculos" );
        ...
        $data3  = array(
            ...
            'precioUnitario'=>$precio,
            'ivaItem'=>$ivaxitem,
            'montoretencion'=>$gravadas,
            'ventasGravadas'=>$gravadas,
            'codRetencion'=>$calculos,
            'ivaRetenido'=>$ivaRetenido,
            'descripcion'=>$procucto." ".$observacionesItem
    ...
    public function resumenRetencion(){

        $numeroControl = $this->input->post( "numeroControl" );
        $codigoGeneracion = $this->input->post( "codigoGeneracion" );

        $traedetalleRete = $this->resumen_model->traedetalleRete( $numeroControl, $codigoGeneracion );
        echo json_encode( $codigoGeneracion );
    }
