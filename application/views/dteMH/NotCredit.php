    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <h3 id='infoFactura'>Nota de Credito  // Buscar documento a relacionar<h6 class="text texr-info" ></h6></h3>
                </div>
                <div class="col-sm-2">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <table id="example2" class="table table-striped table-bordered compact" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Cliente</th>
                                                <th>fecha</th>
                    ...
                    "columns": [
                        {
                            ...
                            data: "fecha", width: "18px",    
                        },
                        {
                            data: "item", width: "10px",    
                        },
                        {
                            data: "descripcion",
                        },
                        {
                            data: "montoPorFormaPag",width: "25px",  
                        },
                        {
                            data: "ivaPercibido", width: "15px",                        
                        },
                        {
                            data: "iva13", width: "15px",                
                        },
                        {
                            data: "retencionRenta",  width: "15px",                           
                        },
                        {
                            "data": null,
