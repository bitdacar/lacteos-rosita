                                                    ...
                                                    <div class="col-md-12 col-sm-12 ">
                                                        ...
                                                        <select class="form-control-sm" id="item154">
                                                         ...
                                                         <input class="form-control-sm" id="numPagoElecNPE" placeholder="NPE de Pago" />
														  <input type="text" class="form-control-sm" id="cuentaArea" placeholder="Cuenta Libre" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group date" id="myDatepicker2">
                                                    <input type="text" id="fovial" class="form-control-sm col-sm-12" disabled />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group date" id="myDatepicker2">
                                                    <input type="text" id="cotrans" class="form-control-sm col-sm-12" disabled />
                                                </div>
                                            </div>
                                        </div>
...
<script>
 ...
 function llenacombos(){
    ...
    $(document).ready(function() {
        ...
        /*$('#item80').on("input", function() {
            llenartext($('#item84').val());
        });*/
 ...
 tableDetalle3 = $('#examplePro').DataTable({
    ...
    window.onload = function() {
        ...
        console.log(minutos);
        $('#item11').val(fecha.getHours() + ':' + minutos);
    }
    ...
    $('#Cuerpodocumento').submit(function() {
        ...
        if (numeroControl != '' || codigoGeneracion != '') {
            ...
            if ($('#tipodocSelect').val() == 'store') {
                var url = '<?=base_url()?>mhdte/Cuerpodocumento/fcgas';
            } else {
                var url = '<?=base_url()?>mhdte/Cuerpodocumento/storegasccf';
            }
    ...
    function resumenConsulta(tipoConsulta) {
        ...
        if ($('#tipodocSelect').val() == 'store') {
            var url = '<?=base_url()?>mhdte/Cuerpodocumento/ingresoResumenGasFC';
        } else {
            var url = '<?=base_url()?>mhdte/Cuerpodocumento/ingresoResumengasCCF';
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                impGas = JSON.parse(respuesta.nombreTributo);
                $('#fovial').val(impGas[1].valor);
                $('#cotrans').val(impGas[2].valor);
                $('#totalon').val(respuesta.montoPorFormaPag);
                }else{
                     mensaje('Informacion', 'Factura sera enviada, Verificar en procesos', 'info');
                }
                 if(tipoConsulta=="fin"){
    ...
    function llenarTabla(numeroControl, codigoGeneracion) {
            ...
            success: function(data) {
                ...
                tableDetalle = $('#example').DataTable({
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        $(api.column(4).footer()).html(friTotal.toFixed(2));
                    },
      ...
      function imprimir(){
         if ($('#tipodocSelect').val() == "store") {
               url='<?php echo base_url();?>reportes/Cfgas/Cfgas';

            } else {

                 url='<?php echo base_url();?>reportes/CcfeGas/CcFeGas';
            }
 $.ajax({
    type: 'POST',
    url:url ,
