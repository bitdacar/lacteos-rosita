					...
					<div class="well profile_view">
						<div class="col-sm-12">
							<h2 class="brief"><i>Autenticacion con MH</i></h4>
								...
								<div class="right col-sm-8 text-center">
									<input type="text" id="user" class="form-control" value="02033110660019"> <br>
								</div>
								<br>
								<div class="right col-sm-8 text-center">

									<input type="password" id="senia" class="form-control" value="<?php echo $this->session->userdata('autenticamh');?>">
