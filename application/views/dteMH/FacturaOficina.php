                                    ...
                                    <table class=" table-bordered" style="width:100%">
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <button id="partidaBtn" onclick="modalPartida()" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lgPart">Partida Contable</button>
                                            </th>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="form-control-sm col-md-8" id="item80" placeholder="cantidad"></td>
                                            <td>
                                                <div class="form-group ">
                                                    <input type="text" id="item81" required="required" class="form-control-sm col-md-4 col-sm-4" placeholder="Codigo producto">
                                                    <select class="form-control-sm col-md-8 col-sm-8" id="item84" col-md-8 col-sm-8>

                                                    </select>
                                                    <textarea id="observacionesItem" rows="1" required="required" class="form-control" placeholder="Descripcion"></textarea>
                                                    
                                                </div>
                                            </td>
                                            <td>

                                                <input type="number" class="form-control-sm col-md-3 col-sm-3" id="item85" placeholder="precio" step="0.01"> 
                                                ...
                                                <input type="text" id="promo" class="form-control-sm col-md-2 col-sm-2" placeholder="Promociones" />
                                            </td>
...
<script>
    ...
    $('#Cuerpodocumento').submit(function() {
        ...
        if (numeroControl != '' || codigoGeneracion != '') {
            ...
            var url = '<?=base_url()?>mhdte/Cuerpodocumento/storeOf'
            $.ajax({
                type: "POST",
                url: url,
                data: Datos,
    ...
    $("#Resumen").click(function() {
        ...
        resumenConsulta("fin");
        $("#partidaBtn").prop( "disabled", false );
    ...
    function imprimir() {
        if ($('#tipodocSelect').val() == "store") {
            url = '<?=base_url()?>reportes/facConsOF/facConsOF';

        } else {

            url = '<?=base_url()?>reportes/CcFeOF/CcFeOF';
        }
        $.ajax({
            type: 'POST',
            url: url,
            ...
            success: function(data) {
                ...
                tableDetalle = $('#example').DataTable({
                        ...
                        data: "item"
                                ...
                                },
                                {
                                    ...
                                    "mRender": function(data, type, value) {
                                        numero=0;
                                        if($('#tipodocSelect').val()=="store"){
                                            numero=value["precioUnitario"];
                                            return($.fn.dataTable.render.number( ',', '.', 2 ).display(numero));
                                        }else{
                                            numero=value["precioUnitario"];
                                            return($.fn.dataTable.render.number( ',', '.', 2 ).display(numero));
                                        }
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        $(api.column(5).footer()).html(friTotal.toFixed(2));
                    },
