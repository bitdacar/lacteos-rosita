                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="col-md-8 col-sm-8  form-group ">
                                                    ...
                                                    <input type="text" class="form-control " id="direccionCli" placeholder="Direccion Cliente">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" class="form-control " id="item153" placeholder="condicionOperacion" value="2">
                                                <input type="hidden" class="form-control " id="item154" placeholder="Contrato N°" value="01">
                                                <input type="hidden" class="form-control " id="item157" placeholder="Contrato N°" value="01">
                                                <input type="hidden" id="item158" class="form-control-sm col-md-6" placeholder="dias/mes/anios" value="60">
                                                <div class="col-md-12 col-sm-12  form-group ">
                                                    <br>
                                                    <label>Destino Fisico de envio:</label>
                                                    <input type="text" id="destino" required="required" class="form-control-sm col-md-12" placeholder="Destino">
                                                </div>
                            ...
                            <form class="form-horizontal" id="Cuerpodocumento">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6  form-group ">
                                        ...
                                        <div class="col-md-6 col-sm-6  form-group ">
                                            <input type="text" class="form-control-sm col-md-4" id="sacos" placeholder="Sacos"> <input type="hidden" class="form-control" id="Qesp" placeholder="Quintales Espanioles">
                                        </div>
                                        <div class="col-md-6 col-sm-6  form-group ">
                                            <input type="text" class="form-control-sm col-md-4" id="item80" placeholder="cantidad">
                                            <select class="form-control-sm col-md-6" id="item83">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Subtotal</th>
                                                            <th>
                                                                <button type="button" id="Resumen" class="btn btn-success btn-sm">Guardar y Enviar MH</button>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group date" id="myDatepicker3">
                                            <input type="hidden" id="totalon" class="form-control-sm col-sm-12" disabled />
                                        </div>
                                    </div>
                                </div>
                                ...
                                success: function(data) {
                                    ...
                                    tableDetalle = $('#example').DataTable({
                                        ...
                                        "footerCallback": function(row, data, start, end, display) {
                                            ...
                                            $(api.column(7).footer()).html(friTotal.toFixed(3));
                                        },
