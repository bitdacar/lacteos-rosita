							...
							<div class="x_content">
								...
								<form class="form-horizontal" id="receptor">
									<div class="col-md-12 col-sm-12 ">
										<div class="col-md-12 col-sm-12 ">
											<select class="form-control-sm" id="item153" hidden>
												<option value="1">Contado</option>
												<option value="2">Crédito</option>
												<option value="3">Otro</option>
												<option value="Ci">Consumo Interno</option>
											</select>
											<select class="form-control-sm" id="item154" hidden>
												<option value="01">Billetes y monedas</option>
												<option value="02">Tarjeta Debito</option>
												<option value="03">Tarjeta Credito</option>
											</select>
											<input class="form-control-sm" id="numPagoElecNPE" placeholder="NPE de Pago" hidden />
											<input class="form-control-sm" id="cuentaArea" placeholder="Cuenta Libre" hidden />
										</div>
										<input type="text" id="txt1" class="form-control-sm col-md-3 col-sm-3" placeholder="Codigo Cliente" hidden>
										<select class="form-control-sm  col-sm-9" id="select1" hidden>
									...
									<div class="col-md-5 col-sm-5">
										<button type="submit" id="btnReceptor" class="btn btn-secondary btn-sm">Nueva Venta</button>
								...
								<form class="form-horizontal" id="Cuerpodocumento">
									...
									<div class="form-group row">
										<label class="control-label col-md-3 col-sm-3 col-xs-3">Placa</label>
										<div class="col-md-9 col-sm-9 col-xs-9">
											<input type="text" class="form-control-sm " id="item80" placeholder="cantidad">
											<span class="fa fa-car form-control-feedback right" aria-hidden="true"></span>
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label col-md-3 col-sm-3 col-xs-3">Nombre Titular</label>
										<div class="col-md-9 col-sm-9 col-xs-9">
											<input type="text" id="item81" required="required" class="form-control-sm" placeholder="Codigo producto">
											<select class="form-control-sm" id="item84">
												<option value="59">No hay productos Selecionado</option>

											</select>
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label col-md-3 col-sm-3 col-xs-3">DUI / licencia</label>
										<div class="col-md-9 col-sm-9 col-xs-9">
											<input type="number" class="form-control-sm " id="item85" placeholder="precio" step="0.01">
											<select class="form-control-sm " id="item83" disabled>
									...
									<div class="form-group row">
										...
										<div class="col-md-9 col-sm-9 col-xs-9">
											...
											<input type="text" id="promo" class="form-control-sm col-md-2 col-sm-2" placeholder="Promociones" hidden />
										</div>
									</div>
